...
export class StockAdjustmentsController {
  ...
  @ApiOperation({
    ...
    description:
      'Create a stock adjustment and update product stock atomically. Requires authentication.',
  })
  @ApiResponse({
    status: 201,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve a paginated list of stock adjustments. Requires authentication.',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve all stock adjustments for a specific product. Requires authentication.',
  })
