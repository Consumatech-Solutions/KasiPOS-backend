...
export class PurchaseOrdersController {
  ...
  @ApiOperation({
    ...
    description:
      'Create a new purchase order. Order code is generated automatically. Requires authentication.',
  })
  @ApiResponse({
    status: 201,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve a paginated list of purchase orders for the current store. Requires authentication.',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve a specific purchase order by its ID. Requires authentication.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Update the status of a purchase order (e.g., mark as completed or cancelled). Does NOT automatically update stock. Requires authentication.',
  })
  @ApiParam({ name: 'id', type: String, description: 'Purchase order UUID' })
  @ApiResponse({
    status: 200,
