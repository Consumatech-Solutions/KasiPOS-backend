...
export class StoresController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Return the store associated with the user.',
  })
  ...
  @ApiResponse({
    status: 403,
    description: 'Forbidden — not store owner or no store',
  })
  ...
  @ApiResponse({
    status: 201,
    description:
      'Store assigned; store admin receives SMS with temporary password and reset link.',
  })
  @ApiResponse({
    status: 400,
    description: 'Store already has an owner or user with this phone exists.',
  })
  @ApiResponse({ status: 401, description: 'Unauthorized.' })
  @ApiResponse({
    status: 403,
  ...
  @ApiResponse({
    status: 400,
    description: 'Invalid payload or phone already exists',
  })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  ...
  @ApiResponse({
    status: 200,
    description: 'Return the store with all admin fields.',
  })
  @ApiResponse({ status: 401, description: 'Unauthorized.' })
  @ApiResponse({
    status: 403,
  ...
  adminUpdate(
    @Param('id') id: string,
    @Body() adminUpdateStoreDto: AdminUpdateStoreDto,
  ) {
