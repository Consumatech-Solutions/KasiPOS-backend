...
class EnabledModulesDto {
  ...
  @ApiProperty({
    example: false,
    description: 'Enable show VAT in checkout module',
  })
  @IsOptional()
...
export class AdminCreateStoreDto {
  ...
  @ApiPropertyOptional({
    example: 'uuid-here',
    description:
      'User ID of the store admin (owner). If provided, this user becomes the store owner; if omitted, leave empty and assign later via assign-store.',
  })
  @IsUUID()
  @IsOptional()
  ownerId?: string;
  ...
  @ApiPropertyOptional({
    ...
    description: 'Enabled modules configuration',
  })
  @ValidateNested()
  @Type(() => EnabledModulesDto)
  @IsOptional()
  ...
  @ApiPropertyOptional({
    ...
    description: 'Trading hours for each day of the week',
  })
  @ValidateNested()
  @Type(() => TradingHoursDto)
  @IsOptional()
